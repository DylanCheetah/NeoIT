...
public:
    ...
    void                    PlayMusic(int soundIndex, FMOD_CHANNEL**channel);
...
private:
    ...
    static FMOD_RESULT F_CALLBACK  fmodFileOpenCallback(const char *fileName,
    ...
    static FMOD_RESULT F_CALLBACK  fmodFileReadCallback(void *handle, void *buffer,
        unsigned int sizebytes, unsigned int *bytesread, void *userdata);
    static FMOD_RESULT F_CALLBACK  fmodFileSeekCallback(void *handle, unsigned int pos,
        void *userdata);
};
