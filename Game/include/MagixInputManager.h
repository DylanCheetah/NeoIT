...
public:
    ...
    void keyHeld(OIS::Keyboard *keyboard, const OIS::KeyCode &key, const unsigned int &text, 
        bool held);
    void inputHeldKey();
    void setInputBox(OverlayElement *inputBox, const String &caption, unsigned short limit, 
        bool clear, const String &startText, bool bTempStorage, bool bNewLine, bool bHideText);
