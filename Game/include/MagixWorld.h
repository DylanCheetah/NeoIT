...
public:
    ...
    void addWaterPlane(const Vector3 &position, const Real &scaleX, const Real &scaleZ,
        const String &matName = "Terrain/CalmWater", const String &playSound = "");
    void addObject(const String &meshName, const Vector3 &position, const Vector3 &scale,
        const Real &pitch, const Real &yaw, const Real &roll, const String &playSound = "",
    ...
    void addStaticGeometry(Entity *ent, const Vector3 &position, const Quaternion &orientation,
        const Vector3 &scale);
