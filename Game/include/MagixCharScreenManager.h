...
public:
    ...
    void initialize(MagixExternalDefinitions *def, MagixEffectsManager *effectsMgr, 
        MagixAlertBox *alertBox, MagixUnit *unit, SceneManager *sceneMgr, OverlayElement *name, 
        OverlayElement *backdrop);
    void initializeText(const unsigned short &i, OverlayElement *text);
    void initializeBackNextButtons(OverlayElement *back, OverlayElement *next,
        OverlayElement *del, OverlayElement *backText, OverlayElement *nextText,
        OverlayElement *delText);
    void initializeLRButtons(const unsigned short &i, OverlayElement *lButton, 
        OverlayElement *rButton);
    void initializeSliders(const unsigned short &i, OverlayElement *slider, 
        OverlayElement *sliderMarker);
